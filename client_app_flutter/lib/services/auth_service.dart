...
class AuthService {
  ...
  static const String _adminEmail = String.fromEnvironment(
    'ADMIN_EMAIL',
    defaultValue: 'admin@choice-app.com',
  );
  static const String _adminPassword = String.fromEnvironment(
    'ADMIN_PASSWORD',
    defaultValue: 'admin123456',
  );
  static const String _legacyAdminEmail = 'admin@choice.local';
  static const String _legacyAdminPassword = 'admin12345';
  ...
  static bool _isLocalAdminCredentials(String email, String password) {
    ...
    return (candidate == _adminEmail.trim().toLowerCase() ||
            candidate == _legacyAdminEmail) &&
        (password == _adminPassword || password == _legacyAdminPassword);
  }
  ...
  static Future<bool> _tryRemoteAdminLogin(
    ...
    if (remote == null || !remote.success || (remote.token ?? '').isEmpty) {
      return false;
    }
  ...
  static Future<bool> loginAdmin({
    ...
    // Локальный fallback проверяем сразу, чтобы вход в дев-админку
    // не зависел от таймаута удаленного auth-сервиса.
